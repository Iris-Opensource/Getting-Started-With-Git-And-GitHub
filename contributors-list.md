## List of the amazing contributors in Iris Club's Getting-Started-With-And-GitHub ! 🎉
⚠️ ```Donot remove anyone's name or change the template, in that case your PR will not be merged``` ⚠️

Template:
```
**Name** : <Siddharth Ceri> <br />
**Link to profile** : [Sid1005](https://github.com/Sid1005) <br />
**About Me** : <br />
<Hey guys, I am Siddharth Ceri from PES University and I am looking forward to contributing to opensource softwares.> <br />
```
